        ...
        <div class="col">
            ...
            <form action="/workers" method="POST">
                ...
                <div class="form-group">
                    ...
                    placeholder="Ingresar número de documento del trabajador" value="{{old('document')}}">
                </div>
                <div class="form-group">
                    <label for="name">Nombres</label>
                    <input type="text" class="form-control" id="name" name="name" 
                    placeholder="Ingresar nombres del trabajador" value="{{old('name')}}">
                </div>
                <div class="form-group">
                    <label for="lastname">Apellidos</label>
                    <input type="text" class="form-control" id="lastname" name="lastname" 
                    placeholder="Ingresar apellidos del trabajador" value="{{old('lastname')}}">
                </div>
                <div class="form-group">
                    <label for="telephone">Celular</label>
                    <input type="number" class="form-control" id="telephone" name="telephone" 
                    placeholder="Ingresar número de teléfono o celular del trabajador" value="{{old('telephone')}}">
                </div>
                <div class="form-group">
